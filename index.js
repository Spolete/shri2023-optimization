function Header() {
  ...
  return (
    <header className="header">
      <a href="/Users/andrey/Public" className="header__logo" aria-label="Яндекс.Дом"></a>
...
{expanded ? 'Закрыть меню' : 'Открыть меню'}
      ...
      <ul
        ...
        <li className="header__item">
          <a className="header__link header__link_current" href="/Users/andrey/Public" aria-current="page">Сводка</a>
        </li>
        <li className="header__item">
...
function Main() {
  ...
  let sizes = [];
  const onSize = size => sizes = sizes.concat(size);
